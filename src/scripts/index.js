...
const markdownEditor = ace.edit('markdown-editor', { // eslint-disable-line -- ace already loaded from in-page script
    mode: 'ace/mode/markdown',
    newLineMode: 'unix',
    wrap: true,
})
const htmlEditor = ace.edit('html-editor', { // eslint-disable-line -- ace already loaded from in-page script
    mode: 'ace/mode/html',
    newLineMode: 'unix',
    wrap: true,
})
